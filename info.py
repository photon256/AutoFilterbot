...
PICS = (environ.get('PICS' ,'https://envs.sh/VcP.jpg')).split()
UPTIME = time.time()
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://envs.sh/VcP.jpg")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'BEST_NEWW')
